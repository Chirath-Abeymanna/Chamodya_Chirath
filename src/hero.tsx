...
const Hero = () => {
  ...
  return (
    <div
      id="hero"
      className="relative w-hero bg-hero left-[30%] h-[100vh] overflow-hidden"
    >
      ...
      {/* About card */}
      <div
        className={`about-card absolute top-60 left-5 w-[100%] max-w-[35rem] h-[100%] max-h-[15rem] p-8 mr-6 rounded-md bg-[#101014] text-white `}
      >
      ...
      {/* Project Cards */}
      <div className="absolute top-[70%] left-0 w-full h-max flex justify-around">
        <div
          className={`project-card w-[12rem] h-[10rem] p-8 rounded-md bg-[#101014] text-white `}
        >
          <div
            className={`relative ${animate ? "fade-in-up fade-delay-2" : ""}`}
          >
            <h1 className="text-5xl mb-5 font-Lexend text-center">
              <Counter endNumber={NoProject} />
            </h1>
            <p className="text-[12px] space-y-8 mb-5 leading-5 text-[#CFCFCF] text-center">
              projects completed
            </p>
          </div>
        </div>
        ...
        <div
          className={`Achievement-card w-[12rem] h-[10rem] p-2 pt-8 rounded-md bg-[#101014] text-white `}
        >
          <div
          ...
          >
            <div className="flex mb-5 ml-5 h-12">
              <h1 className="text-5xl font-Lexend text-center  flex">
                <i className="text-5xl fa fa-trophy mr-1"></i>
        ...
        <div
          className={`Skills-card w-[12rem] h-[10rem] p-2 pt-8 rounded-md bg-[#101014] text-white `}
        >
          <div
            className={`relative ${animate ? "fade-in-up fade-delay-2" : ""}`}
          >
        ...
        <div
          className={`Tech-card w-[12rem] h-[10rem] p-2 pt-8 rounded-md bg-[#101014] text-white`}
        >
          <div
            className={`relative ${animate ? "fade-in-up fade-delay-2" : ""}`}
          >
            <h1 className="text-5xl mb-5 font-Lexend text-center">TECH</h1>
            <p className="text-[12px] space-y-8 mb-5 leading-5 text-[#CFCFCF] text-center">
              Enthusiast
            </p>
          </div>

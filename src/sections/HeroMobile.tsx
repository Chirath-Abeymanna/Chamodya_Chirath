...
function HeroMobile() {
  ...
  return (
    <div className="relative h-max top-[3rem] bg-background  pb-20 overflow-x-hidden">
      <div className="relative flex justify-center items-center pb-[9vh] Profile  w-[100vw] h-[100vh]  text-white font-poppins">
        <div>
          <div className="flex justify-center h-max">
            <h1
              id="nameMobile"
              className="relative text-[11vw]  top-20 font-guriella tracking-wider text-name font-bold"
            >
              Chamodya Chirath
            </h1>
          </div>
          <div className="relative top-[2vw] flex justify-center h-max m-10 ">
            <button className="relative p-2 font-spartan font-medium text-white text-[4vw] ">
              <span className="relative flex h-[2vw] w-[2vw] -left-4 top-[3vw]">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-sky-400 opacity-75"></span>
                <span className="relative inline-flex rounded-circle h-[2vw] w-[2vw] bg-green-400"></span>
              </span>
              <span className="relative top-0 ml-3 ">Availabe for Hire</span>
            </button>
          </div>
      ...
      <div className="about me h-[100vh] w-[100vw] pr-8">
        <TextAnimation
          text=""
      ...
      <div className="relative h-max bg-background rounded-md  mr-5 ml-5">
              ...
              <h2 className="pt-[3vh] mb-2 text-xl flex h-max justify-end ">
                <a href="CV.pdf" download="Chamodya_Chirath.pdf">
                  <button className="flex h-max  text-[4vw] hover:text-[#4c77ab]">
                    <div className="w-[2vw] h-[2vw] bg-[#4c77ab] mr-2 rounded-circle  transition-[ease-in-out] "></div>{" "}
                    Get CV
                  </button>
                </a>
              </h2>
